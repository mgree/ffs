...
bench$activity <- factor(bench$activity, levels = c("overall", "reading", "loading", "saving", "writing"))
...
micro$activity <- factor(micro$activity, levels = c("overall", "reading", "loading", "saving", "writing"))
microPlot <- 
